...
class RandChest
{
    ...
    public function Rand(Player $player)
    {
        $menu = InvMenu::create(InvMenu::TYPE_CHEST);

        $menu->readonly();
        $menu->setName(TF::GRAY . "➤ " . TF::GOLD . "Plot Rand");
        ...
        $menu->setListener(function (player $player, item $itemClickedOn, Item $itemClickedwith): bool {
            ...
            $noPerms = "§6Plot§8 » §cDu hast nucht dei folgenden rechte";
            $spieler = $player->hasPermission("spieler.rand");
