...
class PlotLevelSettings
{
	...
	/** @var int */
	public $roadWidth = 7, $plotSize = 32, $groundHeight = 64, $claimPrice = 0, $clearPrice = 0, $disposePrice = 0, $resetPrice = 0, $mergePrice = 50000, $fillPrice = 20000;
	/** @var bool */
	...
	public function __construct(string $name, array $settings = []) {
		...
		if(!empty($settings)) {
            ...
            $this->mergePrice = self::parseNumber($settings, "MergePrice", 50000);
			$this->fillPrice = self::parseNumber($settings, "FillPrice", 20000);
