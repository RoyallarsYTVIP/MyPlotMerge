...
class UnMergeTask extends Task
{
	...
	public function __construct(MyPlot $plugin, Plot $plot, Player $player, $direction, int $maxBlocksPerTick = 256)
	{
		...
		$this->grass = $plotLevel->roadBlock;
	...
	public function onRun(int $currentTick): void
	{
		...
		switch($this->player->getDirection()){
			case 0:
				$direction = "east";
				$this->player->sendMessage("east - Task");
				break;
			case 1:
				$direction = "south";
				$this->player->sendMessage("south - Task");
				break;
			case 2:
				$direction = "west";
				$this->player->sendMessage("west - Task");

				break;
			case 3:
				$direction = "north";
				$this->player->sendMessage("north - Task");
